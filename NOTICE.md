...
This software can submit real-money event-contract orders only after multiple explicit gates are satisfied. Trading can result in total loss of committed principal. Nothing in this project is financial, investment, legal, tax, or compliance advice.
